...
async def next_page(bot, query):
    ...
    btn.insert(1, 
        [
            InlineKeyboardButton('OWNER', url='https://t.me/gpl_kavin'),
            InlineKeyboardButton('ᴄᴏɴᴛᴀᴄᴛ', url='https://t.me/gpl_kavin')
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Sᴜᴘᴘᴏʀᴛ US ♥️')
            else:
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇs 🤖', url='https://t.me/gpl_kavin'),
            InlineKeyboardButton('💥 OWNER ♥️', url='https://t.me/gpl_kavin')
            ],[
            InlineKeyboardButton('💞 sᴜᴘᴘᴏʀᴛ 💞', url='https://t.me/gpl_kavin'),
            InlineKeyboardButton('👩‍💻 ʀᴇᴘᴏ ✨', url='https://t.me/gpl_kavin'),
            ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('👩‍💻 sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ 👩‍💻', url='https://t.me/gpl_kavin'), #Please Change your bot username
